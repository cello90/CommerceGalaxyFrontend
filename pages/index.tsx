        ...
        <main className="container mx-auto px-4">
          ...
          >
            ...
            <p className="mb-6 text-center max-w-md">
              Join the universe of intergalactic commerce. Trade goods, join trade associations, and dominate the galaxy!
            </p>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <button type="submit" className="px-4 py-2 bg-blue-600 rounded hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
